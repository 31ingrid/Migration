...
FINMATmeanGM=matrix(0,12,11);FINMATvarGM=matrix(0,12,11);FINMATvarGM_raw=matrix(0,12,11);FINMATmeanGM_raw=matrix(0,12,11);
for(exp in 1:11){#was 1:11
 ...
 natmort=c(0.4,0.4)
 SS0=c(6834,6834) #initial stock biomass.
 Q1=mat
 Q2=mat_a5012
 ...
 for(popstat in 1:12){  #was 1:4
  if(popstat<5){ MIG=1;}
  if(popstat==1){SS0=c(6834,6834)}
  if(popstat==2){SS0=c(68340,68340)}
  if(popstat==3){SS0=c(683,683)}
  if(popstat==4){SS0=c(683400,683400)}
  if(popstat==5){SS0=c(6834,6834)}
  if(popstat==6){SS0=c(68340,68340)}
  if(popstat==7){SS0=c(683,683)}
  if(popstat==8){SS0=c(683400,683400)}
  if(popstat>8){ MIG=2;}
  if(popstat==9){SS0=c(6834,6834)}
  if(popstat==10){SS0=c(68340,68340)}
  if(popstat==11){SS0=c(683,683)}
